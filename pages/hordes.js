    ...
    <>
      ...
      <AuthGuard>
        ...
        <div className={styles.body}>
          ...
          {hordes.length === 0 && <p style={{ color: '#7a5a50', fontStyle: 'italic' }}>No hordes yet.</p>}
          <div className={styles.hordesGrid}>
            {hordes.map((horde) => (
              <div key={horde.id} className={styles.hordeCard}>
                <div className={styles.hordeHeader}>
                  {horde.bannerImage ? <img src={horde.bannerImage} alt={horde.name} className={styles.hordeBanner} /> : <div className={styles.hordeBannerPlaceholder}>Banner</div>}
