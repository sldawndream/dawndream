...
const ETERNAL_PRESS_DATABASE_ID = process.env.NOTION_ETERNAL_PRESS_DATABASE_ID;

export async function getEternalPressArticles() {
  const response = await fetch(
    `https://api.notion.com/v1/databases/${ETERNAL_PRESS_DATABASE_ID}/query`,
    {
      method: 'POST',
      headers: {
