    ...
    <>
      ...
      <AuthGuard>
        ...
        <div className={styles.body}>
          ...
          {bloodlines.length === 0 && <p style={{ color: '#7a5a50', fontStyle: 'italic' }}>No bloodlines yet.</p>}
          <div className={styles.grid}>
            {bloodlines.map((bl) => (
              <div key={bl.id} className={styles.card}>
                {bl.bannerImage ? <img src={bl.bannerImage} alt={bl.name} className={styles.banner} /> : <div className={styles.bannerPlaceholder}>Bloodline Banner</div>}
                ...
                <div className={styles.cardFooter}>
                  ...
                  <span className={styles.statusWrap}><span className={styles.statusDot}></span><span className={styles.statusLabel}>Active</span></span>
                </div>
              </div>
            ))}
          </div>
