      ...
      <table width="520" cellpadding="0" cellspacing="0" style="max-width:520px;width:100%;background:#0d0408;border:1px solid #2a0a14;border-radius:10px;overflow:hidden;">
        ...
        <tr>
          <td style="padding:36px 40px 10px;">
            <p style="font-family:'Georgia',serif;font-size:10px;letter-spacing:0.3em;color:#6a3030;text-transform:uppercase;margin:0 0 14px 0;">Blood Covenant — Account Security</p>
            ...
            <p style="font-size:15px;color:#b09880;line-height:1.8;margin:0 0 12px 0;">
              Hello, <strong style="color:#e0cdb8;">${player.avatar_name}</strong>.
            </p>
            <p style="font-size:15px;color:#b09880;line-height:1.8;margin:0 0 20px 0;">
              A password reset was requested for your DawnDream account. Click the button below to set a new password. This link will expire in <strong style="color:#e0cdb8;">1 hour</strong>.
            </p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
              <tr>
                <td align="center">
                  <a href="${resetUrl}" style="display:inline-block;background:#2a0a14;color:#e8a090;padding:14px 36px;border-radius:5px;text-decoration:none;font-family:'Georgia',serif;font-size:12px;letter-spacing:0.18em;text-transform:uppercase;border:1px solid #7a2030;">
                    Reset My Password →
                  </a>
                </td>
              </tr>
            ...
            <p style="font-size:12px;color:#5a3028;line-height:1.8;margin:0 0 8px 0;">
              If you did not request a password reset, you can safely ignore this email. Your account remains secure.
            </p>
            <p style="font-size:11px;color:#3a1a14;line-height:1.8;margin:0;">
              If the button above does not work, copy and paste this link into your browser:<br>
              <span style="color:#5a2828;word-break:break-all;">${resetUrl}</span>
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="background:#0a0306;border-top:1px solid #1e0a10;padding:18px 40px;text-align:center;">
            <p style="font-family:'Georgia',serif;font-size:9px;color:#3a1a14;letter-spacing:0.2em;text-transform:uppercase;margin:0 0 6px 0;">
              DawnDream Vampire System &nbsp;·&nbsp; Second Life RPG
            </p>
            <p style="font-size:11px;color:#2a1010;margin:0;">
              <a href="https://dawndreamsl.com" style="color:#4a2020;text-decoration:none;">dawndreamsl.com</a>
            </p>
          </td>
        </tr>
